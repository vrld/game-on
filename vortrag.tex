...
\title{Game On}
\subtitle{Spiele programmieren mit LÖVE}
\author{vrld}
\date{GPN 11}
...
\sframe{
	...
	\normalsize
	Spiele programieren mit LÖVE \\[.3cm]
	\lolight{GPN 11 // vrld}
}
...
\tframe{LÖVE}{
	\begin{itemize}
		...
		\item \url{www.love2d.org/forums} - Ausführliche Hilfe
...
\begin{frame}[fragile]
	\frametitle{Hello, LÖVE}
	\color{hilight}{main.lua}\color{black}
	\begin{lstlisting}[escapechar=!]
		!\KW{function}! love.draw()
		    love.graphics.print(!\LIT{"Hello, LÖVE"}!, !\LIT{10}!, !\LIT{10}!)
		!\KW{end}!
	\end{lstlisting}
\end{frame}
